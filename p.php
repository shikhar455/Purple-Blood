...
<?php echo $_SESSION['user'] ?> </h3>
   ...
   <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" style="left: 0px; top: 0px; visibility: visible; animation-name: fadeInUp; height:440px">
			...
			<div class="card-body pt-1">
                  ...
                  <h6 class="mb-0 text-center pt-1 pb-1 text-white for-title">Band Name : <span  style="text-transform: uppercase;"> <?php echo $_SESSION['band_name'] ?></span></h6>
                  
                   <h6 class="text-muted mb-1 mt-2 text-center" ><span style="text-transform: uppercase;"> <?php echo $_SESSION['user']; ?></span></h6>
                        <hr class="m-1">
                    <p class="mb-2 mt-2 text-center">Email : <?php echo $_SESSION['email'] ?></p>
                    <p class="mb-2 mt-2 text-center">Feedback : <?php echo $_SESSION['feedback'] ?></p>
                    <div class="for-cont  text-center mt-3">
                    <h6 class="mb-2" style="flex:1"><i class="fa fa-phone"> <small> 1 : </small> </i> <?php echo $_SESSION['number1'] ?></h6>
                    <h6 class=""  style="flex:1"><i class="fa fa-phone"> <small> 2 : </small> </i> <?php echo $_SESSION['number2'] ?></h6></div>
